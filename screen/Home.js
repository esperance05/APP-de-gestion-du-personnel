...
const Home = () => {
  ...
  const next = () => {
   ...
   return (
    ...
    <TouchableOpacity onPress={next} style={{position:"absolute",bottom:50,paddingHorizontal:100,paddingVertical:20,backgroundColor:"#0288d1",borderRadius:20,flexDirection:"row",gap:10,alignItems:"center"}}  > 
